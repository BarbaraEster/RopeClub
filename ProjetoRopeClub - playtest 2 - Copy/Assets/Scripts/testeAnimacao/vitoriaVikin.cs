...
public class vitoriaVikin : MonoBehaviour {
	...
	Animator vikinVitoria; 					// transicao daanimacao
	Rigidbody2D vikinRigidbody;				//Fisica do contato

	void Aweke (){
	//Atribuindo as referencias
		vikinVitoria = GetComponent <Animator> ();
		vikinRigidbody = GetComponent <Rigidbody2D> ();
	...
	{
		bool movimento = 0;
		vikinVitoria.SetBool("parado", movimento);
